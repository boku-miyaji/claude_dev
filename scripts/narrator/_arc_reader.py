...
## 通常の出力
前回の解釈と比べて有意な変化がある場合のみ更新する。その際 change_summary に「何が前回と変わったか」を1-2文で書く（前回がない場合は change_summary を省略）。
{"phase":"exploration|immersion|reflection|reconstruction|leap","narrative":"1-2文の具体的な説明","confidence":0.0-1.0,"change_summary":"前回は〇〇だったが、今週は△△に変わった"}"""
