...
add-zle-hook-widget () {
	# undefined
	builtin autoload -XUz /usr/share/zsh/functions/Misc
}
add-zsh-hook () {
	emulate -L zsh
	local -a hooktypes
...
export PATH=/home/node/.cursor-server/bin/54c27320fab08c9f5dd5873f07fca101f7a3e070/bin/remote-cli\:/home/node/.cursor-server/bin/54c27320fab08c9f5dd5873f07fca101f7a3e070/bin/remote-cli\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/local/share/npm-global/bin
