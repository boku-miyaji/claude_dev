...
export PATH='/home/node/.cursor-server/bin/faa03b17cce93e8a80b7d62d57f5eda6bb6ab9f0/bin/remote-cli:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/share/npm-global/bin'
