...
プロジェクトの**変更履歴**と**報告履歴**の2つを時系列で記録する。
...
| 判断 | 理由 |
|------|------|
| 変更ログと報告ログの2本立て | ドキュメントの変更経緯と、クライアント等への報告履歴は別の関心事。両方残すことで「何を報告したか」「その後何が変わったか」を追跡できる |
...
| 日付 | いつ決めたか | Yes |
| 意思決定内容 | 何を決めたか | Yes |
| 経緯 | 誰と・どのような場で・何が報告されてこの意思決定に至ったか | Yes |
| 選択肢 | 選ばれなかった選択肢も含む | Yes |
| 判断根拠 | なぜそう決めたか。検証結果に基づく場合はその精度・バージョンを含む | Yes |
...
| # | 日付 | テーマ | 意思決定内容 | 関連検証 |
|----|------|--------|------------|---------|
| 001 | {date} | {theme} | {何を決めたか} | {関連する検証項目} |
...
#### 判断根拠
{なぜそう決めたか。検証結果に基づく場合はその精度・バージョンを含む}
